...
def calculate_psnr(img1, img2):
    """
    Calculate PSNR between two images in range [0,255].
    """
...
def calculate_ssim(img1, img2):
    """
    Calculate SSIM for grayscale or RGB images.
    Images must be in range [0,255].
    """
    ...
    if img1.ndim == 3:
        if img1.shape[2] == 3:
            ...
            return _ssim_single_channel(
                np.squeeze(img1), np.squeeze(img2)
            )
